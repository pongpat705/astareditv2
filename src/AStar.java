...
public class AStar<T> {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        int station_lat = stations.findColumn("station_lat");
        int station_lng = stations.findColumn("station_lng");
        ...
        while (stations.next()) {
            ...
            lat = Double.valueOf(stations.getString(station_lat));
            lng = Double.valueOf(stations.getString(station_lng));
            Station station = new Station(station_name_str,lat,lng);
        ...
        for (int i = 0; i<stationList.size();i++){
            ...
            for (int j = 0; j<stationList.size();j++){
                map.put(stationList.get(j).getStations(),  stationList.get(j).getLat());
        ...
        for (int i = 0; i<list.size();i++){
            ...
            //hueristic.put(list.get(i).keySet(),list.get(i).get())
        }
